...
export interface AiModel {
  ...
  params?: string | null;
  command?: string | null;
  badge?: ('Official Pro' | 'Fast' | 'Alias' | 'Heavy' | 'Custom') | null;
  visibility: 'public' | 'hidden' | 'private';
  /**
   * Optional model weights file uploaded by Admin
   */
...
export interface Tournament {
  ...
  /**
   * Master Controller Endpoint URL (e.g. https://mc.ello5.com/arena/your-id)
   */
  mcUrl: string;
  /**
   * Benchmark dataset filename (e.g. frcl-bench-v2.json)
   */
  dataset?: string | null;
  prize?: string | null;
  description?: string | null;
